...
<body>
	<div class="container">
		...
		<br></br><label>Enter BPM Levels :</label>
		...
		<br></br><label>Does the patient have diabetes:</label>
		<input class="form-control form-control-sm" type="checkbox" name="vital2" id="vital2" style="display:inline-block; width:300px;margin-top:25px;"">
	...
	<script>
		var websocket=new WebSocket("ws://localhost:8080/WebSocket3/VitalCheckEndPoint");
